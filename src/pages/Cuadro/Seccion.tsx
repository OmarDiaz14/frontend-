  ...
  const handleSubmit = async (event: { preventDefault: () => void }) => {
    ...
    try {
      ...
      Swal.fire({
        icon: "success",
        title: "¡Exito!",
        text: "Se ha agregado la sección con exito",
      });
                  ...
                  <div className="card shadow-lg border-0 rounded-lg mt-5">
                    <div className="card-header">
                      <h3 className="text-center font-weight-light my-4">
                        Cuadro General de Clasificación Archivística
                      </h3>
                    </div>
                    <div className="card-body">
                      <form onSubmit={handleSubmit}>
                          ...
                          <div className="col-md-6">
                            <div className="form-floating">
                              <input
                                ...
                                id="inputSeccion"
                                type="text"
                                placeholder="Sección"
                                value={seccion}
                                onChange={(e) => setSeccion(e.target.value)}
                              />
                              <label htmlFor="inputSeccion">Sección</label>
                            </div>
                          </div>
                          <div className="col-md-6">
                            <div className="form-floating">
                              ...
                              />
                              <label htmlFor="inputCodigo">Código</label>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="form-floating mb-3">
                          ...
                          />
                          <label htmlFor="inputDescripcion">Descripción</label>
                        </div>
